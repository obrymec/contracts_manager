	...
	if (network_manager ()) {
		...
		// Checking the given data.
			...
			if (Array.isArray (server.errors)) sign_message_box (server.errors [0].message); else {
				...
				load_view ("./sources/features/dashboard/dashboard.html", "div.views", '', "Loading..."); set_cookie ("contracts_user", server.user_id, (20 / 60));
			}
...
$ (() => {
   ...
   $ ("button.login-sign-up").click (() => load_view ("./sources/features/sign_up/sign_up.html", "div.views", '', "Loading..."));
   // Removes this script.
