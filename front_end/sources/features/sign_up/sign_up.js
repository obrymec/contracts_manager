...
function sign_up () {
	...
	if (network_manager ()) {
		...
		// Checking the given data.
			...
			// Otherwise.
			else load_view ("./sources/features/sign_in/sign_in.html", "div.views", '', "Loading...");
...
$ (() => {
   ...
   $ ("button.sign-up-login").click (() => load_view ("./sources/features/sign_in/sign_in.html", "div.views", '', "Loading..."));
   // Removes this script.
