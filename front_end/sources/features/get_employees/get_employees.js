	...
	if (typeof item === "object" && toolbar instanceof CrudView) {
		...
		// For availables employees.
			...
			new Object ({text: "Faults", title: "View the mistakes made by this employee.", click: () => {
				// Draws a widget to display any mistake association.
				window.empcard = empcard; sup_popup ("./sources/features/get_mistakes/get_mistakes.html", ["msk_crud"]);
...
function load_availables_employees () {
	...
	load_view ("./sources/features/available_employees/available_employees.html", window.emps_tc.get_tab_content_id (), '', "Loading...");
...
function load_affected_employees () {
	...
	load_view ("./sources/features/affected_employees/affected_employees.html", window.emps_tc.get_tab_content_id (), '', "Loading...");
	// Updates browser cookies.
